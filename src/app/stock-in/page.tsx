...
import { ArrowDownToLine, ScanLine, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function StockInPage() {
  ...
  const handleBarcodeSearch = (e: React.FormEvent) => {
    ...
    const found =
      inventoryStore.findByBarcode(clean) ||
      inventoryStore.findBySku(clean);
    ...
    if (found) {
      ...
      setErrorMessage(
        `No product found matching barcode or SKU "${clean}".`
      );
    }
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-emerald-600 dark:text-emerald-400">
                ...
                <strong className="text-emerald-800 dark:text-emerald-100">
                  {successResult.newQty} {successResult.unit}
                </strong>.
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 text-xs bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl"
                  >
                    <option value="Supplier Batch Delivery">
                      Supplier Batch Delivery
                    </option>
                    <option value="Restock Order">Restock Order</option>
                    <option value="Customer Return">Customer Return</option>
                    <option value="Warehouse Transfer In">
              ...
              <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm font-semibold text-emerald-900 dark:text-emerald-100 mt-0.5">
                    Current: <strong>{currentStock}</strong> + Stock In:{" "}
